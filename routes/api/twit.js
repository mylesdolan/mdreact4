...
/* just for test
        router.get('/initial/:keystring',  (req, res) => {
            console.log('aboutyenutter')
            res.send('about')
        });
*/
 ...
 //router.get('/', (req, res) => {
    //router.get('/', (req, res) => {
   router.get('/initial/:keystring', (req, res) => {
//May 2020 introducing searchstring
 //   router.get('/:keyword', (req, res) => {
       let twitthing = req.params.keystring;
       let twitothing = req.query.keystring;
        console.log("fuckfucko",twitthing);

        console.log("fuckfuckoo",twitothing);
     ...
     //   T.get('search/tweets', { q: 'Enniskillen since:2011-07-11', count: 100 }, function(err, data, response) {
//       T.get('search/tweets', { q: '${twitthing} since:2011-07-11', count: 100 }, function(err, data, response) {

       var str1 = twitthing;
       var str2 = " since:2011-07-11";
       var reso = str1.concat(str2);

       T.get('search/tweets', { q: reso, count: 100 }, function(err, data, response) {
